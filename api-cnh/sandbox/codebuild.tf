...
resource "aws_codebuild_project" "api-cnh-sandbox" {
  name         = "api-cnh-sandbox"
  service_role = aws_iam_role.servicerole-sandbox.arn
...
resource "aws_iam_role" "servicerole-sandbox" {
  name               = "servicerole-api-cnh-sandbox"
  assume_role_policy = data.aws_iam_policy_document.assume_role.json
}

resource "aws_iam_role_policy" "ecr_policy" {
  name   = "ecr_policy"
  role   = aws_iam_role.servicerole-sandbox.name
