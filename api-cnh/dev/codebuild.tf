...
resource "aws_codebuild_project" "api-cnh-dev" {
  name         = "api-cnh-dev"
  service_role = aws_iam_role.servicerole-dev.arn
...
resource "aws_iam_role" "servicerole-dev" {
  name               = "servicerole-api-cnh-dev"
  assume_role_policy = data.aws_iam_policy_document.assume_role.json
}

resource "aws_iam_role_policy" "ecr_policy" {
  name   = "ecr_policy"
  role   = aws_iam_role.servicerole-dev.name
